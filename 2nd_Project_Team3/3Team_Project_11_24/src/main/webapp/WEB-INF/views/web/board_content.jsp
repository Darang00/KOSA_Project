...
/*	var cnt=1; //전역 변수
	function bookmarkToggle(){
		var img1 = document.getElementById("empty_bookmark");
		var img2 = document.getElementById("checked_bookmark");
		
		if(cnt%2==1){
			empty_bookmark.src="images/checked_bookmark.png";
			checked_bookmark.src="images/empty_bookmark.png";
		} else{
			empty_bookmark.src="images/empty_bookmark.png";
			checked_bookmark.src="images/checked_bookmark.png";
		}
		cnt++;
	} */
			...
			<center>
				...
				<table width="80%" border="1">
					...
					<%-- 	<%	
						...
						<!-- <img src="images/empty_bookmark.png" id="empty_bookmark" width="15px" height="18px">
						<img src="images/checked_bookmark.png" id="checked_bookmark" width="15px" height="18px">
						<input type="button" value="bookmark_toggle" onclick="bookmarkToggle() = location.href ='bookMarks.user'"> -->
