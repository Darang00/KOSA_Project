...
<body>
	...
	<c:set var="totalBookmarkcount" value="${requestScope.totalBookmarkcount}" />
			...
			<table width="80%" border="1" cellspacing="0" align="center">
				...
				<tr>
					<td colspan="3" align="center">
						<!--이전 링크 --> 
						<c:if test="${cpage > 1}">
							<a href="boadList.user?boardname=${boardname}&cp=${cpage-1}&ps=${pagesize}&boardname=${boardname}">이전</a>
						</c:if>
						<!-- page 목록 나열하기 -->
