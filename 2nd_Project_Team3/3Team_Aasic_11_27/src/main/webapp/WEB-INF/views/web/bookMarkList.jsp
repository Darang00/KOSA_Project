			...
			<table width="80%" border="1" cellspacing="0" align="center">
				...
				<c:forEach var="bookmarks" items="${requestScope.bookmarklist}">
					<tr onmouseover="this.style.backgroundColor='skyblue'" onmouseout="this.style.backgroundColor='white'">
						<td align="center">${bookmarks.idx}</td>
						<td align="center">${bookmarks.boardname}</td>
						<td align="left">
						...
						<td align="center">${bookmarks.userid}</td>
						<td align="center">${bookmarks.writedate}</td>
						<td align="center">${bookmarks.lovenum}</td>
					</tr>
				</c:forEach>
				<!-- forEach()  -->
				<tr>
